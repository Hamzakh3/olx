        ...
        return (
            ...
            <div className='myads'>
                {userInfo && userInfo !== null ?
                        ...
                        <div className='settingUserProfile'>
                            ...
                            {editMode ?
                                <>
                                    ...
                                    <button disabled={ifValidName()} className={!ifValidName() ? 'btnSave' : 'changeNameBtnDisbale btnSave'} onClick={() => { this.props.updateUserName(userId, changeUName); this.setState({ editMode: false }) }}>Save</button>
                                 </>
                    ...
                    : userInfo === null ? this.props.get_userInfo(this.props.userId) : console.log()}
